...
def register_routes(app):
    ...
    def registros_eventos():
        ...
        items_db = conn.execute("SELECT * FROM eventos WHERE fecha_registro LIKE ? ORDER BY id DESC", (fecha_like,)).fetchall()
        ...
        archivador_items = get_archivador_as_items(conn, "Formulario de Eventos", fecha_filtro, user_ident, is_admin)
